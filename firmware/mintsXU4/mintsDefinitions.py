...
dataFolder                = choose_folder("Please choose a downloads directory")
...
tlsCertsFile              = choose_file("Please choose TLS Certs file","crt")  # The path of your TLS cert

latestOn                  = False
mqttOn                    = True

credentials               = load_yaml_file(choose_file("Please choose the mints credentials file","*.yaml"))
...
nodeInfo                   = load_yaml_file(choose_file("Please choose the MINTS Nodes List","*.yaml"))
